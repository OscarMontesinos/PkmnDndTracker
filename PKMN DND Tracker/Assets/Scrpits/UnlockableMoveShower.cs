...
public class UnlockableMoveShower : MovShower
{
        ...
        switch (mode)
        {
            ...
            case Mode.leveling:
                if (locked)
                {
                    ...
                    {
                        case 1:
                            UIManager.Instance.pkmn.lvl1Moves.Add(transform.GetSiblingIndex());
                            UIManager.Instance.lvl1UnlockableMoves.SetActive(false);
                            if (UIManager.Instance.pkmn.lvl2Moves.Count < UIManager.Instance.pkmn.CalculateLvl2MoveSlots(UIManager.Instance.pkmn.lvl) &&
                                UIManager.Instance.pkmn.basePkmn.lvl2LearnableMoves.Count >= UIManager.Instance.pkmn.CalculateLvl2MoveSlots(UIManager.Instance.pkmn.lvl))
                            {
                                UIManager.Instance.lvl2UnlockableMoves.SetActive(true);
                            }
                            else if (UIManager.Instance.pkmn.lvl3Moves.Count < UIManager.Instance.pkmn.CalculateLvl3MoveSlots(UIManager.Instance.pkmn.lvl) &&
                                UIManager.Instance.pkmn.basePkmn.lvl3LearnableMoves.Count >= UIManager.Instance.pkmn.CalculateLvl3MoveSlots(UIManager.Instance.pkmn.lvl))
                            {
                                UIManager.Instance.lvl3UnlockableMoves.SetActive(true);
                            }
                            else
                            {
                                UIManager.Instance.LvlUpNext(2);
                            }
                                break;
                        case 2:
                            UIManager.Instance.pkmn.lvl2Moves.Add(transform.GetSiblingIndex());
                            UIManager.Instance.lvl2UnlockableMoves.SetActive(false);
                            if (UIManager.Instance.pkmn.lvl3Moves.Count < UIManager.Instance.pkmn.CalculateLvl3MoveSlots(UIManager.Instance.pkmn.lvl) &&
                                UIManager.Instance.pkmn.basePkmn.lvl3LearnableMoves.Count >= UIManager.Instance.pkmn.CalculateLvl3MoveSlots(UIManager.Instance.pkmn.lvl))
                            {
                                UIManager.Instance.lvl3UnlockableMoves.SetActive(true);
                            }
                            ...
                            break;
                        case 3:
                            UIManager.Instance.pkmn.lvl3Moves.Add(transform.GetSiblingIndex());
                            UIManager.Instance.lvl3UnlockableMoves.SetActive(false);
                            UIManager.Instance.LvlUpNext(2);
                            break;
                    }
                }
    ...
    public void SetMove(Mode mode, MoveSO move, Pkmn pkmn, int lvl)
    {
        this.mode = mode;
        this.lvl = lvl;
